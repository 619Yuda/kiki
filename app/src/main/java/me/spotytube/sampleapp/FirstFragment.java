...
public class FirstFragment extends Fragment {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new Tab1Fragment(), "Tout");
        adapter.addFragment(new Tab1Fragment(), "événement");
        adapter.addFragment(new Tab1Fragment(), "Lieux");
        adapter.addFragment(new Tab1Fragment(), "Artistes");
